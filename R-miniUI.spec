...
Source0  : https://cran.r-project.org/src/contrib/miniUI_0.1.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1521240464
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library miniUI|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
